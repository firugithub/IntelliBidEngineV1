...
import { Settings, Database, Cloud, Brain, Save, AlertCircle, Users, Trash2, Activity, TrendingUp, Clock, DollarSign, CheckCircle, XCircle } from "lucide-react";
    ...
    <div className="container mx-auto p-6 max-w-4xl">
      ...
      <Tabs defaultValue="agents-openai" className="space-y-4">
        <TabsList className="grid w-full grid-cols-6">
          ...
          <TabsTrigger value="agent-metrics" data-testid="tab-agent-metrics">
        ...
        <TabsContent value="agent-metrics">
          <AgentMetricsTab />
        </TabsContent>
