...
import RftDraftReviewPage from "@/pages/RftDraftReviewPage";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/template-management" component={TemplateManagementPage} />
      <Route path="/rft-draft-review" component={RftDraftReviewPage} />
