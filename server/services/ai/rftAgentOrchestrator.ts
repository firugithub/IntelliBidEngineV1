...
export async function generateAgentDrivenRft(
  ...
  console.log(`🤖 Starting agent-driven RFT generation for: ${context.projectName}`);
  ...
  console.log(`✅ Agent-driven RFT generation complete - ${sections.length} sections generated`);
