...
BEGIN
    ...
    RAISE NOTICE '  • AI RFT Templates: % (Multi-stakeholder templates)', template_count;
    ...
    RAISE NOTICE '  4. Upload organization DOCX templates via Template Management page';
